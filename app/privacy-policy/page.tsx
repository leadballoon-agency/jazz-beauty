...
export const metadata = {
  title: 'Privacy Policy | Jazz Beauty Clinic Torquay',
  description: 'Privacy Policy for Jazz Beauty Clinic CO2 Laser Treatments in Torquay, Devon',
}
        ...
        <div className="prose prose-neutral max-w-none space-y-8">
          <section>
            ...
            <p className="text-neutral-700 leading-relaxed">
              Jazz Beauty Clinic & Training Academy ("we", "our", or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website co2lasertorquay.co.uk and use our services.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-white rounded-xl p-6 border border-neutral-200">
              <p className="font-semibold mb-2">Jazz Beauty Clinic & Training Academy</p>
              <p className="text-neutral-700">4 Union Street</p>
              <p className="text-neutral-700">Torquay, Devon TQ2 5PL</p>
              <p className="text-neutral-700 mt-3">
                <strong>Phone:</strong> <a href="tel:+441803269859" className="text-primary-600 hover:text-primary-700">01803 269859</a>
              </p>
              <p className="text-neutral-700 mt-1">
                <strong>Email:</strong> <a href="mailto:jazzhairandbeauty@gmail.com" className="text-primary-600 hover:text-primary-700">jazzhairandbeauty@gmail.com</a>
              </p>
              <p className="text-neutral-700 mt-1">
                <strong>Instagram:</strong> <a href="https://www.instagram.com/jazzhairandbeautytorquay" target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:text-primary-700">@jazzhairandbeautytorquay</a>
              </p>
            </div>
          </section>
