        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="space-y-5 sm:space-y-6 lg:space-y-8 animate-slide-up text-center lg:text-left">
            ...
            <div className="inline-flex items-center px-5 sm:px-6 py-2.5 sm:py-3 bg-white border-2 border-accent-400 rounded-full mx-auto lg:mx-0 shadow-lg">
              <span className="text-primary-700 font-bold text-sm sm:text-base tracking-wide">Jazz Beauty Clinic Torquay</span>
            </div>

            {/* Main Heading */}
            <h1 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-bold leading-tight">
              CO2 Laser
              <span className="block gradient-text mt-1 sm:mt-2">Skin Resurfacing</span>
            </h1>

            <p className="text-sm sm:text-lg md:text-xl text-neutral-600 leading-relaxed max-w-xl mx-auto lg:mx-0 px-2 sm:px-0">
              Transform your skin with advanced CO2 fractional laser technology. Treat wrinkles, acne scars, sun damage and pigmentation with long-lasting results. Award-winning clinic with 15+ years experience.
            </p>
            ...
            <div className="bg-gradient-to-r from-primary-50 to-white border-2 border-primary-200 rounded-2xl p-5 sm:p-6 mx-auto lg:mx-0 max-w-xl shadow-lg">
              <p className="text-primary-700 font-bold text-xs sm:text-sm mb-3 tracking-wide">CO2 Laser Treatments in Torquay, Devon</p>
              <div className="flex justify-center gap-4">
                <div className="text-center bg-white border-2 border-primary-200 rounded-xl p-4 sm:p-5 shadow-md flex-1">
                  <p className="text-2xl sm:text-3xl font-bold text-primary-700 mb-1">£TBC</p>
                  <p className="text-sm sm:text-base text-neutral-700 font-medium">Full Face</p>
                ...
                <div className="text-center bg-white border-2 border-accent-400 rounded-xl p-4 sm:p-5 shadow-md flex-1">
                  <p className="text-2xl sm:text-3xl font-bold text-primary-700 mb-1">£TBC</p>
                  <p className="text-sm sm:text-base text-neutral-700 font-medium">Targeted Areas</p>
                  <p className="text-xs text-accent-500 mt-2 font-semibold">Eyes, Mouth, Neck</p>
                </div>
              </div>
              <p className="text-xs sm:text-sm text-neutral-500 mt-3 sm:mt-4 text-center font-medium">Results Last 1+ Years • Collagen Stimulation</p>
            </div>
            ...
            <div className="grid grid-cols-2 sm:flex sm:items-center sm:justify-center lg:justify-start gap-4 sm:gap-6 pt-2 max-w-md mx-auto lg:mx-0">
              <div className="text-center">
                <p className="text-lg sm:text-xl font-bold text-primary-600">15+</p>
                <p className="text-xs sm:text-sm text-neutral-600 whitespace-nowrap">Years Experience</p>
              </div>
              <div className="text-center">
                <p className="text-lg sm:text-xl font-bold text-primary-600">30-60</p>
                <p className="text-xs sm:text-sm text-neutral-600 whitespace-nowrap">Minute Session</p>
              </div>
              <div className="text-center">
                <p className="text-lg sm:text-xl font-bold text-primary-600">1+ Year</p>
                <p className="text-xs sm:text-sm text-neutral-600 whitespace-nowrap">Results Last</p>
              </div>
              <div className="text-center">
                <p className="text-lg sm:text-xl font-bold text-primary-600">Award</p>
                <p className="text-xs sm:text-sm text-neutral-600 whitespace-nowrap">Winning Clinic</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative mt-8 lg:hidden">
            <div className="relative mx-auto max-w-[320px]">
              <img
                src="https://static.wixstatic.com/media/83d91b_ab40a730c96d469ab44a0700f62c7662~mv2.jpg"
                alt="Jazz Kaur - Award-Winning Aesthetic Practitioner"
            ...
            <div className="relative h-[600px] flex items-center justify-center p-8">
              ...
              <div className="relative flex items-center justify-center h-full w-full">
                ...
                <div className="relative w-full max-w-md">
                  <img
                    src="https://static.wixstatic.com/media/83d91b_ab40a730c96d469ab44a0700f62c7662~mv2.jpg"
                    alt="Jazz Kaur - Award-Winning Aesthetic Practitioner"
                    className="rounded-2xl shadow-2xl w-full animate-float object-cover"
                  />
                </div>
              </div>
              ...
              <div className="hidden lg:block absolute bottom-8 left-1/2 -translate-x-1/2 w-full max-w-lg">
                <div className="bg-white/90 backdrop-blur-lg rounded-2xl p-6 shadow-xl">
                  <div className="text-center">
                    <h3 className="text-xl font-bold text-neutral-800 mb-2">Jazz Kaur - Award-Winning Practitioner</h3>
                    <div className="flex justify-center items-center space-x-2 text-primary-600">
                      <span className="font-medium">Level 7 Qualified</span>
