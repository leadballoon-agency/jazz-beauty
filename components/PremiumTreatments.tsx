...
export default function PremiumTreatments({ onBookingClick }: PremiumTreatmentsProps) {
  const treatments = [
    {
      icon: '✦',
      title: 'Targeted CO2 Laser',
      description: 'Focus on specific areas like eyes, mouth or forehead',
      features: ['Crow\'s feet treatment', 'Smoker\'s lines reduction', 'Forehead rejuvenation', '20-30 minute session'],
      price: '£TBC',
    ...
    },
    {
      ...
      description: 'Complete facial skin resurfacing for maximum transformation',
      features: ['Full face treatment', 'Deep wrinkle reduction', 'Acne scar improvement', '45-60 minute session'],
      price: '£TBC',
    ...
    },
    {
      ...
      description: 'Target sun damage and wrinkles on neck and chest area',
      features: ['Neck rejuvenation', 'Décolletage resurfacing', 'Sun damage repair', '30-45 minute session'],
      price: '£TBC',
    ...
    <section id="treatments" className="py-12 sm:py-16 md:py-24 bg-gradient-to-b from-primary-50 to-white">
      <div className="max-w-7xl mx-auto section-padding">
        <div className="text-center mb-6 sm:mb-8 lg:mb-10 space-y-2 sm:space-y-3">
          <span className="text-primary-600 font-medium tracking-wider uppercase text-xs sm:text-sm">CO2 Laser Skin Resurfacing</span>
          ...
          <p className="text-sm sm:text-base leading-relaxed text-neutral-600 max-w-2xl mx-auto px-4">
            Advanced fractional CO2 laser technology - each treatment tailored to your unique skin concerns
          </p>
        </div>
        ...
        <div className="mt-8 text-center sm:hidden">
          <p className="text-sm text-neutral-600 mb-3">Need help choosing?</p>
