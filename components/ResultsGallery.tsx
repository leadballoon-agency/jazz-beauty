      ...
      <div className="max-w-7xl mx-auto section-padding">
            ...
            <div className="p-8 sm:p-12 md:p-16 text-center">
              <div className="max-w-2xl mx-auto">
                ...
                <h3 className="text-white text-xl sm:text-2xl lg:text-3xl font-bold mb-4">
                  Welcome to Jazz Beauty Clinic
                </h3>
                <p className="text-white/90 text-sm sm:text-base mb-6 leading-relaxed">
                  Experience advanced CO2 Laser skin resurfacing at our award-winning clinic in Torquay, Devon. A relaxed, professional environment designed for your comfort and outstanding results.
                </p>
                <button
        ...
        <div className="mt-10 sm:mt-12 lg:mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
          {[
            ...
            { number: '£TBC', label: 'Starting From' },
