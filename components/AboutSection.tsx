...
export default function AboutSection({ onBookingClick }: AboutSectionProps) {
  const practitioners = [
    {
      name: 'Jazz Kaur',
      title: 'Award-Winning Aesthetic Practitioner',
      image: 'https://static.wixstatic.com/media/83d91b_ab40a730c96d469ab44a0700f62c7662~mv2.jpg',
      bio: "With over 15 years of experience in beauty and aesthetics, I'm passionate about helping my clients achieve their skin goals through safe, effective treatments. As a Level 7 qualified practitioner with teacher training credentials, I bring both expertise and a personalised approach to every treatment. Jazz Beauty Clinic has been recognised with multiple awards including Best Beauty Clinic & Training Academy for the South West 2025 and International Award Winner 2020.",
      qualifications: [
      ...
      <div className="max-w-7xl mx-auto section-padding">
        <div className="text-center mb-6 sm:mb-8 lg:mb-10">
          ...
          <p className="text-sm sm:text-base leading-relaxed text-neutral-600 mt-2 sm:mt-3 max-w-2xl mx-auto px-4">
            Award-winning expertise dedicated to your skin transformation
          </p>
        </div>
