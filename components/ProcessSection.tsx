...
export default function ProcessSection({ onBookingClick }: ProcessSectionProps) {
  const steps = [
    ...
    },
    {
      ...
      description: 'Professional CO2 laser session targeting your areas of concern',
      icon: '🔬',
      duration: '30-60 mins'
    },
    {
      ...
      description: 'Skin renews over 5-10 days with proper aftercare',
      icon: '🌱',
      duration: '7-10 days'
    },
    {
      ...
      description: 'Collagen builds for 3-6 months, results last 1-3 years',
      icon: '✨',
      duration: '3-6 months'
    }
  ]
            ...
            <div>
              <div className="bg-gradient-to-r from-primary-100 to-primary-50 rounded-xl p-4 mb-4">
                <div className="flex items-center mb-2">
                  ...
                  <h4 className="font-bold text-primary-800">Healing & Recovery</h4>
                </div>
                <p className="text-sm leading-relaxed text-primary-700">CO2 Laser requires 7-10 days of healing as your skin renews itself. This downtime is essential for achieving the best possible results.</p>
              </div>
              ...
              <ul className="space-y-2 sm:space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-sm sm:text-base leading-relaxed text-neutral-700">Day 1-3: Redness and swelling as skin begins healing</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary-500 mr-2 sm:mr-3 mt-0.5 sm:mt-1">✓</span>
                  <span className="text-sm sm:text-base leading-relaxed text-neutral-700">Day 5-10: Skin peeling and flaking as it renews</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary-500 mr-2 sm:mr-3 mt-0.5 sm:mt-1">✓</span>
                  <span className="text-sm sm:text-base leading-relaxed text-neutral-700">Month 1-3: Visible improvements in texture and tone</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary-500 mr-2 sm:mr-3 mt-0.5 sm:mt-1">✓</span>
                  <span className="text-sm sm:text-base leading-relaxed text-neutral-700">Month 3-6: Peak results as collagen production continues</span>
                </li>
              </ul>
            </div>
